  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        const result = await dispatch(fetchProductsByCategory('coldDrinks')).unwrap();
        setProducts(result);
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-3xl font-bold mb-6">Cold Drinks</h1>
        <Loader message="Loading cold drinks..." />
      </div>
    );
  }
